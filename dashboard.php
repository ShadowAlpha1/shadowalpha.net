...
<html  lang="en">
   <head>
      ...
      <meta property="og:url" content="https://stormhusky.com/dashboard" />
      <meta property="og:site_name" content="Storm_Husky_ ~ Dashboard" />
      <meta name="keywords" content="<?= $keywords ?>">
      <meta property="twitter:card" content="summary_large_image" />
      <meta property="og:locale" content="en-US" />
      <title data-react-helmet="true">Storm_Husky_ ~ Dashboard</title>
      <!-- endsection -->
      <meta data-react-helmet="true" property="og:title" content="Storm_Husky_ ~ Dashboard" />
         ...
         <div class="container">
            <div class="row justify-content-center">
               <div class="col-md-12 col-lg-10">
                  <h4 class="mbr-section-subtitle mbr-fonts-style mb-4 display-5 text-center"><strong>Welcome back, <?= $_SESSION['userData']['name'] ?>!</strong></h4>

                  <h6 class="mbr-section-subtitle text-white display-5" style="font-size:18px;">Downloads</h6>
                  <table class="table text-white table-bordered border-secondary" style="background: #202020;">
                     <thead>
                        <tr>
                        ...
                        <tr>
                           <th scope="row" class="fw-normal">
                              <div class="text-container">
                                 ...
                                 <a href="<?= $product['Download'] ?>" class="btn btn-primary item-btn display-4 shadow-none" style="border-radius: 100px;">Download</a>
                              </div>
                           </th>
                        </tr>
                        <?php } }
